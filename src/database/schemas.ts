    ...
    for (const type of types) {
      ...
      case `functions`:
        selects.push([
          ...
          `  '' as SYS_SCHEMA, '' as SYS_NAME, '' as BASE_SCHEMA, '' as BASE_OBJ`,
          `from QSYS2.SYSFUNCS`,
      ...
      case `variables`:
        selects.push([
          ...
          `  '' as BASE_SCHEMA, '' as BASE_OBJ, '' as SPECNAME`,
      ...
      case `procedures`:
        selects.push([
          ...
          `  '' as BASE_SCHEMA, '' as BASE_OBJ, '' as SYS_SCHEMA, '' as SYS_NAME`,
          `from QSYS2.SYSPROCS`,
      ...
      case `types`:
        selects.push([
          ...
          `  '' as BASE_SCHEMA, '' as BASE_NAME, '' as SPECNAME`,
          `from QSYS2.SYSTYPES`,
