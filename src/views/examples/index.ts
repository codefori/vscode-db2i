...
export const Examples: SQLExamplesList = {
  ...
  "IBM i Services": [
    ...
    {
      "name": "Application - Command Information",
      "content": [
        "--  minvrm: V7R4M0",
        "--",
    ...
    {
      "name": "History Log - Study job longevity",
      "content": [
    ...
    {
      "name": "IFS - Capture the meta-data for an IFS tree",
      "content": [
        "--  minvrm: V7R3M0",
        "--",
        "--",
    ...
    {
      "name": "IFS - Compare files or trees",
      "content": [
        "--  minvrm: V7R4M0",
        "--",
    ...
    {
      "name": "IFS - For the SQL programmers",
      "content": [
        "--  minvrm: V7R4M0",
        "--",
        "-- Resources:",
    ...
    {
      "name": "Java - Find instances of old Java versions being used",
      "content": [
    ...
    {
      "name": "License Management - Expiration processing",
      "content": [
        "--  minvrm:  v7r2m0",
        "--",
    ...
    {
      "name": "Message Handling  - Query a message file",
      "content": [
        "SELECT",
    ...
    {
      "name": "Message Handling - Abnormal IPL Predictor",
      "content": [
        "--  minvrm:  v7r2m0",
        "--",
    ...
    {
      "name": "PTF - Defective PTF Currency",
      "content": [
        "--  minvrm:  v7r4m0",
        "--",
    ...
    {
      "name": "Password failures over the last 24 hours",
      "content": [
    ...
    {
      "name": "Review the object ownership summary for objects in a library",
      "content": [
    ...
    {
      "name": "Security - Audit Journal CD review",
      "content": [
    ...
    {
      "name": "Security - Auditing configuration for commands",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
    ...
    {
      "name": "Security - Authority Collection (analyze)",
      "content": [
    ...
    {
      "name": "Security - Authority Collection (capture)",
      "content": [
        "--",
    ...
    {
      "name": "Security - Authority Collection (review)",
      "content": [
        "--",
    ...
    {
      "name": "Security - Commands that Limited Capabilities can use",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
    ...
    {
      "name": "Security - DISPLAY_JOURNAL() of the audit journal",
      "content": [
        "--  minvrm:  v7r2m0",
    ...
    {
      "name": "Security - Data areas where any user can see the value (detail report)",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r4m0",
        "--",
        ...
        "       ) dta",
        "  WHERE lib.authorization_user = '*PUBLIC' AND lib.data_execute = 'YES' AND dta.authorization_user =",
        "        '*PUBLIC' AND dta.data_execute = 'YES'",
        "  ORDER BY dtaara_lib, dtaara; "
      ]
    },
    {
      "name": "Security - Data areas where any user can see the value (summary report)",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r4m0",
        "--",
        "-- Data areas that anyone can see the data area value",
        "--",
        "select dtaara_lib, count(*) as data_area_count ",
        "  FROM qsys2.data_area_info, TABLE (",
        "         qsys2.object_privileges('QSYS', dtaara_lib, '*LIB')",
        "       ) lib, TABLE (",
        "         qsys2.object_privileges(dtaara_lib, dtaara, '*DTAARA')",
        ...
        "        '*PUBLIC' AND dta.data_execute = 'YES'",
        "  group by dtaara_lib",
        "  order by data_area_count desc; "
      ]
    },
    {
      "name": "Security - Data areas where anyone can change data area value (detail report)",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r4m0",
        "--",
        ...
        "       ) dta",
        "  WHERE lib.authorization_user = '*PUBLIC' AND lib.data_execute = 'YES' AND dta.authorization_user =",
        "        '*PUBLIC' AND dta.object_operational = 'YES' AND dta.data_read = 'YES' AND dta.data_add =",
        "        'YES' AND dta.data_update = 'YES' AND dta.data_delete = 'YES'",
        "  ORDER BY dtaara_lib, dtaara; "
      ]
    },
    {
      "name": "Security - Db2 for i - Delete attack vector",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
    ...
    {
      "name": "Security - Db2 for i - Insert attack vector",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
    ...
    {
      "name": "Security - Db2 for i - Query attack vector",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
    ...
    {
      "name": "Security - Db2 for i - RENAME attack",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
    ...
    {
      "name": "Security - Db2 for i - Trigger attack vector",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
    ...
    {
      "name": "Security - Db2 for i - Update attack vector",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
    ...
    {
      "name": "Security - How many libraries are OPEN for attack?",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
    ...
    {
      "name": "Security - How many libraries are OPEN for attack? (ownership perspective)",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
    ...
    {
      "name": "Security - IFS Authority Collection",
      "content": [
        "--  minvrm:  v7r4m0",
        "-- ",
    ...
    {
      "name": "Security - IFS directories with a name and owner mismatch not using *PUBLIC *EXCLUDE",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r4m0",
        "--",
    ...
    {
      "name": "Security - IFS first-level directories that are open to attack",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        " WITH OBJS AS (",
        "        SELECT PATH_NAME",
        "            FROM TABLE (",
        "                    QSYS2.IFS_OBJECT_STATISTICS(START_PATH_NAME => '/', subtree_directories => 'NO')",
        ...
        "             )",
        "  WHERE authorization_name = '*PUBLIC' and DATA_EXECUTE = 'YES';"
      ]
    },
    {
      "name": "Security - IFS home directories (detail)",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
        "-- Detailed report of IFS home directories that are not secured from *PUBLIC use",
        "--  ",
        "SELECT ios.path_name AS ifs_home_directory, ios.object_owner AS owner,   ",
        "       data_authority as public_data_authority ",
        "  FROM TABLE(qsys2.ifs_object_statistics(",
        ...
        "                   z.authorization_name = '*PUBLIC' and ",
        "                   (data_authority <> '*EXCLUDE'",
        "                      OR object_management <> 'NO'",
        "                      OR object_existence  <> 'NO'",
        "                      OR object_reference  <> 'NO'",
        "                      OR object_alter      <> 'NO'))",
        "  order by ifs_home_directory;"
      ]
    },
    {
      "name": "Security - IFS home directories (summary)",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
        "-- IFS Home directories where *PUBLIC authorization is NOT set to *EXCLUDE ",
        "--  ",
    ...
    {
      "name": "Security - IFS home directory contents object ownership mismatch (detail report)",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r4m0",
        "--",
    ...
    {
      "name": "Security - IFS home directory contents object ownership mismatch (summary report)",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r4m0",
        "WITH ifs (homes, home_owner) AS (",
    ...
    {
      "name": "Security - IFS home directory ownership",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r5m0",
        "--",
        "-- Find HOME directories that are not owned by the expected user",
        "--",
        "SELECT path_name, object_owner AS current_owner,",
        "       systools.ifs_path(path_name => path_name, subsection => 'FILE NAME') AS home_owner",
        "  FROM TABLE (",
        "      qsys2.ifs_object_statistics(",
        "        start_path_name     => '/home/', ",
        "        object_type_list    => '*ALLDIR', ",
        ...
        "        ignore_errors       => 'YES')",
        "    )",
        "  WHERE object_owner <> systools.ifs_path(path_name => path_name, subsection => 'FILE NAME')",
        "        and path_name not in ('/home/');"
      ]
    },
    {
      "name": "Security - IFS subdirectory object attack vector check",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
        "-- description: Find any files under an IFS path that have the wrong value for owner or *PUBLIC",
        "--",
        "WITH ifs_auts AS (",
        "        SELECT path_name",
        "            FROM TABLE (",
        "                    qsys2.ifs_object_statistics(start_path_name => '/payroll_upload', subtree_directories => 'YES', IGNORE_ERRORS => 'YES')",
        "                )",
        "    )",
        "    SELECT iop.*",
        "        FROM ifs_auts,",
    ...
    {
      "name": "Security - Library List security review",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
    ...
    {
      "name": "Security - Powerful commands",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
    ...
    {
      "name": "Security - QPGMR vs QPGMR_NC",
      "content": [
        "--  minvrm: V7R6M0",
        "--",
        "-- Authorizations that the QPGMR *USRPRF has, but the QPGMR_NC *USRPRF does not have",
        "--",
        "SELECT 'QPGMR' AS user_name, a.authorization_user, a.object_authority, a.authorization_list,",
        "       a.primary_group, a.owner, a.authorization_list_management, a.object_owner,",
        "       a.object_operational, a.object_management, a.object_existence, a.object_alter,",
        "       a.object_reference, a.data_read, a.data_add, a.data_update, a.data_delete, a.data_execute",
        "  FROM TABLE (",
        "         qsys2.object_privileges('QSYS', 'QPGMR', '*USRPRF')",
        "       ) a",
        "       LEFT EXCEPTION JOIN TABLE (",
        "           qsys2.object_privileges('QSYS', 'QPGMR_NC', '*USRPRF')",
        "         ) b",
        "         ON",
        "           CASE",
        "             WHEN a.authorization_user = 'QPGMR' THEN 'QPGMR_NC'",
        "             ELSE a.authorization_user",
        "           END = b.authorization_user AND ",
        "           a.object_authority = b.object_authority AND",
        "           a.authorization_list IS NOT DISTINCT FROM b.authorization_list AND ",
        "           a.primary_group IS NOT DISTINCT FROM b.primary_group AND ",
        "           a.owner = b.owner AND",
        "           a.authorization_list_management = b.authorization_list_management AND ",
        "           a.object_owner = b.object_owner AND",
        "           a.object_operational = b.object_operational AND ",
        "           a.object_management = b.object_management AND ",
        "           a.object_existence = b.object_existence AND ",
        "           a.object_alter = b.object_alter AND",
        "           a.object_reference = b.object_reference AND ",
        "           a.data_read = b.data_read AND ",
        "           a.data_add = b.data_add AND ",
        "           a.data_delete = b.data_delete AND ",
        "           a.data_update = b.data_update AND ",
        "           a.data_execute = b.data_execute;",
        "stop;",
        "--",
        "-- Side by side comparison of QPGMR and QPGMR_NC *USRPRF privileges",
        "--",
        "SELECT 'QPGMR' AS user_profile, a.*",
        "  FROM TABLE (",
        "      qsys2.object_privileges('QSYS', 'QPGMR', '*USRPRF')",
        "    ) a",
        "UNION ALL",
        "SELECT 'QPGMR_NC' AS user_profile, b.*",
        "  FROM TABLE (",
        "      qsys2.object_privileges('QSYS', 'QPGMR_NC', '*USRPRF')",
        "    ) b",
        "  ORDER BY 2;"
    ...
    {
      "name": "Security - QSECOFR vs QSECOFR_NC",
      "content": [
        "--  minvrm: V7R6M0",
        "--",
        "-- Authorizations that the QSECOFR *USRPRF has, but the QSECOFR_NC *USRPRF does not have",
        "--",
        "SELECT 'QSECOFR' AS user_name, a.authorization_user, a.object_authority, a.authorization_list,",
        "       a.primary_group, a.owner, a.authorization_list_management, a.object_owner,",
        "       a.object_operational, a.object_management, a.object_existence, a.object_alter,",
        "       a.object_reference, a.data_read, a.data_add, a.data_update, a.data_delete, a.data_execute",
        "  FROM TABLE (",
        "         qsys2.object_privileges('QSYS', 'QSECOFR', '*USRPRF')",
        "       ) a",
        "       LEFT EXCEPTION JOIN TABLE (",
        "           qsys2.object_privileges('QSYS', 'QSECOFR_NC', '*USRPRF')",
        "         ) b",
        "         ON",
        "           CASE",
        "             WHEN a.authorization_user = 'QSECOFR' THEN 'QSECOFR_NC'",
        "             ELSE a.authorization_user",
        "           END = b.authorization_user AND ",
        "           a.object_authority = b.object_authority AND",
        "           a.authorization_list IS NOT DISTINCT FROM b.authorization_list AND ",
        ...
        "stop;",
        "--",
        "-- Side by side comparison of QSECOFR and QSECOFR_NC *USRPRF privileges",
        "--",
        "SELECT 'QSECOFR' AS user_profile, a.*",
        "  FROM TABLE (",
        "      qsys2.object_privileges('QSYS', 'QSECOFR', '*USRPRF')",
        "    ) a",
        "UNION ALL",
        "SELECT 'QSECOFR_NC' AS user_profile, b.*",
        "  FROM TABLE (",
        "      qsys2.object_privileges('QSYS', 'QSECOFR_NC', '*USRPRF')",
        "    ) b",
        "  ORDER BY 2;"
    ...
    {
      "name": "Security - QSYSOPR vs QSYSOPR_NC",
      "content": [
        "--  minvrm: V7R6M0",
        "--",
        "-- Authorizations that the QSYSOPR *USRPRF has, but the QSYSOPR_NC *USRPRF does not have",
        "--",
        "SELECT 'QSYSOPR' AS user_name, a.authorization_user, a.object_authority, a.authorization_list,",
        "       a.primary_group, a.owner, a.authorization_list_management, a.object_owner,",
        "       a.object_operational, a.object_management, a.object_existence, a.object_alter,",
        "       a.object_reference, a.data_read, a.data_add, a.data_update, a.data_delete, a.data_execute",
        "  FROM TABLE (",
        "         qsys2.object_privileges('QSYS', 'QSYSOPR', '*USRPRF')",
        "       ) a",
        "       LEFT EXCEPTION JOIN TABLE (",
        "           qsys2.object_privileges('QSYS', 'QSYSOPR_NC', '*USRPRF')",
        "         ) b",
        "         ON",
        "           CASE",
        "             WHEN a.authorization_user = 'QSYSOPR' THEN 'QSYSOPR_NC'",
        "             ELSE a.authorization_user",
        "           END = b.authorization_user AND ",
        "           a.object_authority = b.object_authority AND",
        "           a.authorization_list IS NOT DISTINCT FROM b.authorization_list AND ",
        ...
        "stop;",
        "--",
        "-- Side by side comparison of QSYSOPR and QSYSOPR_NC *USRPRF privileges",
        "--",
        "SELECT 'QSYSOPR' AS user_profile, a.*",
        "  FROM TABLE (",
        "      qsys2.object_privileges('QSYS', 'QSYSOPR', '*USRPRF')",
        "    ) a",
        "UNION ALL",
        "SELECT 'QSYSOPR_NC' AS user_profile, b.*",
        "  FROM TABLE (",
        "      qsys2.object_privileges('QSYS', 'QSYSOPR_NC', '*USRPRF')",
        "    ) b",
        "  ORDER BY 2;"
    ...
    {
      "name": "Security - QUSER vs QUSER_NC",
      "content": [
        "--  minvrm: V7R6M0",
        "--",
        "-- Authorizations that the QUSER *USRPRF has, but the QUSER_NC *USRPRF does not have",
        "--",
        "SELECT 'QUSER' AS user_name, a.authorization_user, a.object_authority, a.authorization_list,",
        "       a.primary_group, a.owner, a.authorization_list_management, a.object_owner,",
        "       a.object_operational, a.object_management, a.object_existence, a.object_alter,",
        "       a.object_reference, a.data_read, a.data_add, a.data_update, a.data_delete, a.data_execute",
        "  FROM TABLE (",
        "         qsys2.object_privileges('QSYS', 'QUSER', '*USRPRF')",
        "       ) a",
        "       LEFT EXCEPTION JOIN TABLE (",
        "           qsys2.object_privileges('QSYS', 'QUSER_NC', '*USRPRF')",
        "         ) b",
        "         ON",
        "           CASE",
        "             WHEN a.authorization_user = 'QUSER' THEN 'QUSER_NC'",
        "             ELSE a.authorization_user",
        "           END = b.authorization_user AND ",
        "           a.object_authority = b.object_authority AND",
        "           a.authorization_list IS NOT DISTINCT FROM b.authorization_list AND ",
        ...
        "stop;",
        "--",
        "-- Side by side comparison of QUSER and QUSER_NC *USRPRF privileges",
        "--",
        "SELECT 'QUSER' AS user_profile, a.*",
        "  FROM TABLE (",
        "      qsys2.object_privileges('QSYS', 'QUSER', '*USRPRF')",
        "    ) a",
        "UNION ALL",
        "SELECT 'QUSER_NC' AS user_profile, b.*",
        "  FROM TABLE (",
        "      qsys2.object_privileges('QSYS', 'QUSER_NC', '*USRPRF')",
        "    ) b",
        "  ORDER BY 2;"
    ...
    {
      "name": "Security - Special Authority Data Mart",
      "content": [
        "--  minvrm:  v7r4m0",
        "--",
    ...
    {
      "name": "Security - Special Authority and Db2 data",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
    ...
    {
      "name": "Security - User profile attack vector",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
    ...
    {
      "name": "Security - Users with Limited Capabilities",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "--",
    ...
    {
      "name": "Security - What Database triggers exist?",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r4m0",
        "--",
    ...
    {
      "name": "Security - What are the IFS home directories, where the owner doesn't match the home dir?",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r4m0",
        "--",
    ...
    {
      "name": "Security - Which commands can anyone use?",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r4m0",
        "--",
    ...
    {
      "name": "Security - Which libraries contain commands that anyone use?",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r4m0",
        "--",
    ...
    {
      "name": "Security - Which users are changing data via a remote connection?",
      "content": [
        "--  minvrm:  v7r2m0",
    ...
    {
      "name": "Security - Who is creating objects in the /QOpenSys subdirectory",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "SELECT entry_timestamp,",
    ...
    {
      "name": "Security - Who is creating objects in the IFS root",
      "content": [
        "--  Use Db2 for i to Inject more Security into your IBM i",
        "--  minvrm:  v7r3m0",
        "SELECT entry_timestamp,",
    ...
    {
      "name": "What is our journaling setup, by object type",
      "content": [
    ...
    {
      "name": "Work Management - Active Job info - Temp storage consumers, by memory pool",
      "content": [
        "--",
    ...
    {
      "name": "Work Management - Active Job info - Top ZDA CPU consumers",
      "content": [
        "--  minvrm:  v7r2m0",
    ...
    {
      "name": "Work Management - Job Descriptions",
      "content": [
        "--",
  ...
  "Db2 for i Services": [
    ...
    {
      "name": "SELF - Initial Stack",
      "content": [
        "--  minvrm: V7R4M0",
        "--",
        "--  Reference Material for SQL Error Logging Facility (SELF)",
        "--  https://www.ibm.com/support/pages/node/6828091",
        "--",
        "",
        "--",
        "-- Examine SELF data for one user, including the initial stack detail",
        "--",
        "WITH self_rows AS (",
        "    SELECT ROW_NUMBER() OVER (",
        "           ) AS instance, log.*",
        "      FROM qsys2.sql_error_log log",
        "      WHERE user_name = 'SCOTTF'",
        "  )",
        "  SELECT instance, statement_text, a.*",
        "    FROM self_rows, JSON_TABLE(",
        "           initial_stack,",
        "           'lax $.initial_stack[*]'",
        "           COLUMNS(",
    ...
    },
    {
      ...
      "content": [
        ...
        "",
        "--",
        "-- Turn SELF off, for the current connection",
        "--",
        "SET SYSIBMADM.SELFCODES = '*NONE'; ",
        "stop;",
        "",
        "--",
        "-- Turn SELF on, for the current connection",
        "--",
        "SET SYSIBMADM.SELFCODES = SYSIBMADM.VALIDATE_SELF('-514, -204, -501, +30, -199'); ",
        "stop;",
        "",
        "--",
        "-- Capture details for interesting SQL warnings",
        "--",
        "SET SYSIBMADM.SELFCODES = SYSIBMADM.VALIDATE_SELF('138, 180, 181, 183, 191, 304, 331, 364, 420, 802'); ",
        "stop;",
        "",
        "--",
        "-- Capture details for interesting SQL warnings and errors",
        "--",
        "SET SYSIBMADM.SELFCODES = SYSIBMADM.VALIDATE_SELF('138, 180, 181, 183, 191, 304, 331, 364, 420, 802, -138, -180, -181, -183, -191, -304, -331, -364, -420, -802');",
        "stop;",
        "",
        "-- Background:",
        " ",
        "-- SQLCODE - Description",
        "-- =========================================================",
        "-- +/-138 - Substring function argument invalid",
        "-- +/-180 - Date, time, or timestamp string syntax invalid",
        "-- +/-181 - Date, time, or timestamp string value is invalid",
        "-- +/-183 - Invalid result from a date/time expression",
        "-- +/-191 - MIXED data is not properly formed",
        "-- +/-304 - Numeric conversion error (e.g., overflow)",
        "-- +/-331 - Characters cannot be converted",
        "-- +/-364 - DECFLOAT arithmetic error",
        "-- +/-420 - Character in CAST argument is invalid",
    ...
    {
      "name": "SELF - Log Queries",
      "content": [
        "--  minvrm: V7R4M0",
        "--",
        "--  Reference Material for SQL Error Logging Facility (SELF)",
        "--  https://www.ibm.com/docs/en/i/7.6.0?topic=services-sql-error-log-view",
        "--",
        "",
        "--",
        "-- Summary of SELF for this user (entire user history)",
        "--",
        "SELECT job_name, statement_operation_detail, logged_sqlcode, SUM(e.number_occurrences) AS count, MAX(message_text) AS text",
        "  FROM qsys2.sql_error_log e, TABLE (",
        "         systools.sqlcode_info(logged_sqlcode)",
        "       ) c",
        "  where e.system_user_name = user",
        "  GROUP BY job_name, statement_operation_detail, logged_sqlcode",
        "  ORDER BY count DESC;",
        "stop;",
        "",
        "--",
        "-- Summary of SELF for this user (current connection only)",
        "--",
        "SELECT statement_operation_detail, logged_sqlcode, SUM(e.number_occurrences) AS count, MAX(message_text) AS text",
        "  FROM qsys2.sql_error_log e, TABLE (",
        "         systools.sqlcode_info(logged_sqlcode)",
        "       ) c",
        "  where e.system_user_name = user ",
        "    and e.job_name = qsys2.job_name",
        "  GROUP BY statement_operation_detail, logged_sqlcode",
        "  ORDER BY count DESC;",
        "stop;",
        "",
        "--",
        "-- Detail of SELF for this user (current connection only)",
        "--",
        "SELECT e.job_name, e.logged_time, e.statement_operation_detail, e.logged_sqlcode, e.logged_sqlstate,",
        "       e.number_occurrences, e.statement_text, c.message_text, c.message_second_level_text,",
        "       e.program_library, e.program_name, e.program_type, e.module_name, e.thread_id,",
        "       e.adopted_user_name, e.user_name, e.system_user_name, e.client_acctng, e.client_applname,",
        "       e.client_programid, e.client_userid, e.client_wrkstnname, e.rdb_name, e.initial_logged_time,",
        "       e.initial_job_name, e.initial_thread_id, e.initial_adopted_user_name, e.initial_stack,",
        "       e.reason_code, c.message_id, e.statement_operation",
        "  FROM qsys2.sql_error_log e, TABLE (",
        "         systools.sqlcode_info(logged_sqlcode)",
        "       ) c",
        "  where e.user_name = user and job_name = qsys2.job_name",
        "  ORDER BY e.logged_time DESC;",
        "stop;",
        "",
        "--",
        "-- Detail of SELF for this user (entire user history)",
        "--",
        "SELECT e.job_name, e.logged_time, e.statement_operation_detail, e.logged_sqlcode, e.logged_sqlstate,",
        "       e.number_occurrences, e.statement_text, c.message_text, c.message_second_level_text,",
        "       e.program_library, e.program_name, e.program_type, e.module_name, e.thread_id,",
    ...
    },
    {
      ...
      "content": [
        ...
        "",
        "--",
        "-- Clear out any old SELF data for the TEST user profile",
        "-- (replace 'SCOTTF' with the uppercased user profile name being used to run the tests)",
        "--",
        ...
        "",
        "--",
        "-- Summary of SELF for the TEST user profile",
        "--",
        "SELECT case when logged_sqlcode < 0 then 'ERROR' else 'WARNING' end as SELF_TYPE, count(*) as SELF_COUNT",
        "  FROM qsys2.sql_error_log e",
        "  where e.system_user_name = 'SCOTTF'",
        "  GROUP BY case when logged_sqlcode < 0 then 'ERROR' else 'WARNING' end;",
        "stop;",
        "",
        "--",
        "-- Summary of SELF for the TEST user profile",
        "--",
        "SELECT logged_sqlcode, SUM(e.number_occurrences) AS count, MAX(message_text) AS text",
        "  FROM qsys2.sql_error_log e, TABLE (",
        "         systools.sqlcode_info(logged_sqlcode)",
        "       ) c",
        "  where e.system_user_name = 'SCOTTF'",
        "  GROUP BY logged_sqlcode",
        "  ORDER BY count DESC;",
        "stop;",
        "",
        "--",
        "-- Establish a table to contain SELF test history",
        "-- ",
        "CREATE OR REPLACE TABLE coolstuff.self_hist AS",
        "      (SELECT current date as test_date, c.message_text, e.logged_sqlcode, e.logged_sqlstate, e.number_occurrences,",
        "              e.statement_text, e.statement_operation, e.statement_operation_detail,",
        "              e.program_library, e.program_name, e.program_type, e.module_name, e.logged_time,",
        "              e.job_name, e.user_name, e.client_acctng, e.client_applname, e.client_programid,",
        "              e.client_userid, e.client_wrkstnname, e.initial_stack",
        "          FROM qsys2.sql_error_log e, TABLE (",
        "                 systools.sqlcode_info(logged_sqlcode)",
        "               ) c",
        "          WHERE e.system_user_name = 'SCOTTF')",
        ...
        "",
        "--",
        "-- Save the current SELF results",
        "--",
        "INSERT INTO coolstuff.self_hist",
        "  SELECT CURRENT DATE AS test_date, c.message_text, e.logged_sqlcode, e.logged_sqlstate,",
        "         e.number_occurrences, e.statement_text, e.statement_operation,",
        "         e.statement_operation_detail, e.program_library, e.program_name, e.program_type,",
        "         e.module_name, e.logged_time, e.job_name, e.user_name, e.client_acctng, e.client_applname,",
        "         e.client_programid, e.client_userid, e.client_wrkstnname, e.initial_stack",
        "    FROM qsys2.sql_error_log e, TABLE (",
        "           systools.sqlcode_info(logged_sqlcode)",
        "         ) c",
        "    WHERE e.system_user_name = 'SCOTTF';",
        ...
        "",
        "--",
        "-- Find host variable misalignment ",
        "--",
        "SELECT *",
        "  FROM coolstuff.self_hist",
        "  WHERE logged_sqlcode = 326;",
        "stop;"
      ]
    },
    {
      "name": "SELF - Removing historical rows",
      "content": [
        "--  minvrm: V7R4M0",
        "--",
        "--  Reference Material for SQL Error Logging Facility (SELF)",
        ...
        "",
        "--",
        "-- Delete all SELF data older than 30 days",
        "--",
        "DELETE FROM QSYS2.SQL_ERRORT",
        ...
        "",
        "--",
        "-- Delete all SELF data for the current user",
        "--",
        "DELETE FROM QSYS2.SQL_ERRORT",
        "  WHERE user_name = user;",
        "stop;"
    ...
    {
      "name": "SELF - System-wide controls",
      "content": [
        "--  minvrm: V7R4M0",
        "--",
        "--  Reference Material for SQL Error Logging Facility (SELF)",
        ...
        "",
        "--",
        "-- Turn SELF to capture data for failing SQL statements, system-wide",
        "--",
        "CREATE OR REPLACE VARIABLE SYSIBMADM.SELFCODES VARCHAR(256) ",
        "                  DEFAULT '*ERROR'; ",
        "stop;",
        ...
        "",
        "--",
        "-- Turn SELF to capture data for SQL statements that end with a warning, system-wide",
        "--",
        "CREATE OR REPLACE VARIABLE SYSIBMADM.SELFCODES VARCHAR(256) ",
        "                  DEFAULT '*WARNING'; ",
        "stop;",
        ...
        "",
        "--",
        "-- Turn SELF to capture data for SQL statements that end with a warning or failure, system-wide",
        "--",
        "CREATE OR REPLACE VARIABLE SYSIBMADM.SELFCODES VARCHAR(256) ",
        "                  DEFAULT '*ALL'; ",
        "stop;"
    ...
    },
    {
      ...
      "content": [
        ...
        "",
        "--",
        "-- Examine the SELF instances that are occurring the most frequently",
        "--",
        "SELECT *",
  ...
  "SYSTOOLS for you": [
    ...
    {
      "name": "Analyze IFS storage consumption",
      "content": [
        "-- first time only",
        "cl: crtlib ifsinfo;",
        "",
    ...
    {
      "name": "Audit Journal Data Mart - Deleted Objects",
      "content": [
        "--  minvrm: v7r4m0",
        "--  ",
        "",
    ...
    {
      "name": "Check Software Product Options",
      "content": [
        "--  minvrm: v7r4m0",
        "--",
        "",
    ...
    {
      "name": "Check licences, generate spreadsheets, and send emails",
      "content": [
        "--  minvrm: v7r4m0",
        "--",
    ...
    {
      "name": "Generate a spreadsheet, from a Db2 file",
      "content": [
        "--  minvrm: v7r4m0",
        "--",
    ...
    {
      "name": "Generate a spreadsheet, from an SQL query",
      "content": [
        "--  minvrm: v7r4m0",
        "--",
        "-- https://www.ibm.com/docs/en/i/7.5?topic=services-generate-spreadsheet-scalar-function",
    ...
    {
      "name": "Manage jobs sitting on job queues",
      "content": [
        "--  minvrm: v7r4m0",
        "--",
    ...
    {
      "name": "PING to verify a TCP/IP connection",
      "content": [
        "--  minvrm: v7r4m0",
        "--",
    ...
    {
      "name": "Rename an IFS stream file",
      "content": [
        "--  minvrm: v7r4m0",
        "--",
    ...
    {
      "name": "Reply to QSYSOPR inquiry messages",
      "content": [
        "--  minvrm: v7r4m0",
        "--",
    ...
    {
      "name": "Study job history, CPU top consumers",
      "content": [
        "--  minvrm: v7r4m0",
        "--",
    ...
    {
      "name": "Study job history, temporary storage",
      "content": [
        "--  minvrm: v7r4m0",
        "--",
        "-- https://www.ibm.com/docs/en/i/7.5?topic=services-ended-job-info-table-function",
